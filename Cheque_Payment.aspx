<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Cheque_Payment.aspx.cs" Inherits="com.pridish.Cheque_Payment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        <td>
            <table class="style1">
                <tr>
                    <td class="style14" style="width: 275px">
                        &nbsp;</td>
                    ...
                    <td class="style3" style="width: 117px">
            ...
            <%--<asp:BoundField DataField="RowNumber" HeaderText="Row Number" />--%>
                    ...
                    <asp:TemplateField HeaderText=" Cheque Type">
                            <ItemTemplate>
                                ...
                                <asp:DropDownList ID="ddl_Cheque_Type" runat="server" 
                                     Height="23px"  Width="127px" AppendDataBoundItems ="true" SelectedValue='<%# Eval("Cheque_Type") %>'>
                                    
                                    <asp:ListItem> </asp:ListItem>
                                    <asp:ListItem>CDC </asp:ListItem>
                    ...
                    <asp:TemplateField HeaderText=" Cheque No.">
                        <ItemTemplate>
                            <asp:TextBox ID="txt_Cheque_No" runat="server" Text ='<%# Eval("Cheque_No") %>' ></asp:TextBox> 
    ...
    <tr>
        <td>
            <table class="style1">
                <tr>
                    <td class="style15" style="width: 232px">
                    ...
                    <td>
                            <asp:Button ID="btn_Cancel" CssClass ="header" runat="server" Height="41px" style="font-weight: 700" 
                                Text="Cancel" Width="215px" PostBackUrl="~/Cheque_Payment_List.aspx"  />
                        </td>
                    <td>
                        &nbsp;</td>
                    <td>
